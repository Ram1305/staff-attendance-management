...
class ViewCourse5 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _viewCourse5();
}

class _viewCourse5 extends State<ViewCourse5>{
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            StreamBuilder(
                stream: storage.collection('MlAttendance').snapshots(),
