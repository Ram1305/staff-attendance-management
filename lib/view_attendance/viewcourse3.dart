...
class ViewCourse3 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _viewCourse3();
}

class _viewCourse3 extends State<ViewCourse3>{
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            StreamBuilder(
                stream: storage.collection('PythonAttendance').snapshots(),
