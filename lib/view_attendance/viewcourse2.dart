...
class ViewCourse2 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _viewCourse2();
}

class _viewCourse2 extends State<ViewCourse2>{
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            StreamBuilder(
                stream: storage.collection('CppAttendance').snapshots(),
