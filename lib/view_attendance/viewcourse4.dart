...
class ViewCourse4 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _viewCourse4();
}

class _viewCourse4 extends State<ViewCourse4>{
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            StreamBuilder(
                stream: storage.collection('CloudAttendance').snapshots(),
