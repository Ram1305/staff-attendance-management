...
class _LoginState extends State<Login> {
  ...
  Future<User?> _loginUsingEmailAndPassword({
    ...
    try {
      UserCredential facultyCredential = await auth.signInWithEmailAndPassword(email: email, password: password);
      return facultyCredential.user;
    } on FirebaseAuthException catch (e) {
      if (e.code == "faculty-not-found") {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("No faculty found for that email")),
        );
      }
      return null;
    }
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                final faculty = await _loginUsingEmailAndPassword(
